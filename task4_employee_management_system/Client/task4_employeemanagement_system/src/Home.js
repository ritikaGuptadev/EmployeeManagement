...
export default function Home()
{
	...
	useEffect( () => {
		axios.get(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${currLocation.city}?unitGroup=metric&key=RYEPZFBRMVZHKNJYGZXYRMB3X&contentType=json`)
		.then((response) => {
               ...
               <tbody>
	{
		...
		<th>
			<button className="button" onClick = {() => {
				if(window.confirm("Are u suree ??"))	delStu(e._id);
			}}
			>
			Delete
			</button>
